...
const getCurrentUser = asyncHandler(async(req, res) => {
    return res.status(200).jon(200, req.user, "current user fetched sucessfully")
})
...
const updateAccoutnDetails = asyncHandler(async(req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, user, "Acccount details updated sucessfully"))
})
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccoutnDetails, updateAvatar, updateCoverImage };
